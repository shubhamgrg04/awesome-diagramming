...
* [Pumler](https://pumler.com/) (Freemium, Closed Source, Diagram as code, Ease of use - Easy, Visual Appearance - Modern, supports PlantUML, Mermaid, and Structurizr with real-time collaboration).  
Examples - [Link](https://pumler.com/)
